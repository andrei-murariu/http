...
public class ApiAuthenticationClient {
    ...
    public ApiAuthenticationClient(String  baseUrl, String username, String password) {
        setBaseUrl(baseUrl);
        this.username = "ObIui\\BlsLpRDbUB";
        this.password = "MlJjuzV50w";
        this.urlResource = "https://iot.simfony.net/8189b50fa17c2c1d9f0920544fea15da94897120/ODMy/andrei";
        this.urlPath = "https://iot.simfony.net/8189b50fa17c2c1d9f0920544fea15da94897120/ODMy/andrei";
